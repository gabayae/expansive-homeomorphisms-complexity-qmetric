...
scripts live in the \href{\repourl}{companion repository}
(see the \href{\repourl/tree/main/code}{\texttt{code/}} directory).
...
non-trivial entropy for $\psi_\alpha|_\C$ (see Section~\ref{sec:conclusion}).
\end{remark}
...
\emph{Topological entropy.}  Proposition~\ref{prop:no-compact-invariant}
shows that compact $\psi_\alpha$-invariant sets are $d_\C^s$-trivial,
so standard Bowen entropy vanishes on them.  Defining a meaningful
entropy invariant for the non-compact dynamics of $\psi_\alpha$ on
all of $\C$ --- for instance via asymmetric or volume-growth
entropy analogues --- remains open.
