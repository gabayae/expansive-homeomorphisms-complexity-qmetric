...
We then show that the canonical coordinates of $\psi_\alpha$ are
hyperbolic with contraction rate $\lambda=1/\alpha$, and we
connect orbit separation in the dynamical system to the classical
time hierarchy theorem of Hartmanis and Stearns.  Unstable sets,
conjugate dynamics, and topological entropy estimates for the
scaling map are also worked out.  Concrete algorithms and Python
...
expansive homeomorphisms, it is always positive~\cite{bowen1975}.

This section gives an entropy estimate for $\psi_\alpha$ on
suitable subsets of the complexity space.
